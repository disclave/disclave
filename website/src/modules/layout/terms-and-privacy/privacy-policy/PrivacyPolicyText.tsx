...
export const PrivacyPolicyText: React.VFC = () => {
  return (
    <>
      <T1>Privacy Policy</T1>

      <Paragraph>
        Your privacy is important to us. It is Disclave&#39;s policy to respect your privacy and
        ...
        <Anchor href="https://disclave.com">https://disclave.com</Anchor>, and other sites we own
        and operate.
      </Paragraph>
      <Paragraph>
      ...
      <Paragraph>This policy is effective as of 14 May 2021.</Paragraph>
      <Paragraph>Last updated: 14 May 2021</Paragraph>

      <T2>Information We Collect</T2>
      ...
      <T3>Personal Information</T3>

      <Paragraph>
        We may ask for personal information — for example, when you submit content to us or when you
      ...
      <T3>User-Generated Content</T3>

      <Paragraph>
        We consider &ldquo;user-generated content&rdquo; to be materials (text, image and/or video
        content) voluntarily supplied to us by our users for the purpose of publication on our
        website or re-publishing on our social media channels. All user-generated content is
        associated with the account or email address used to submit the materials.
      </Paragraph>
      <Paragraph>
      ...
      <T3>Legitimate Reasons for Processing Your Personal Information</T3>
      ...
      <T3>Collection and Use of Information</T3>
      ...
      <Paragraph>
        ...
        with information about how visitors use our site to improve our site and your experience on
        it.
      </Paragraph>

      <T3>Security of Your Personal Information</T3>
      ...
      <T3>How Long We Keep Your Personal Information</T3>
      ...
      <T2>Disclosure of Personal Information to Third Parties</T2>
      ...
      <T2>Your Rights and Controlling Your Personal Information</T2>
      ...
      <Paragraph>
        ...
        to provide you with a particular service or offer (for example providing user support), we
        will not deny you goods or services and/or charge you different prices or rates for goods or
        services, including through granting discounts or other benefits, or imposing penalties, or
      ...
      <T2>Additional Disclosures for General Data Protection Regulation (GDPR) Compliance (EU)</T2>

      <T3>Data Controller / Data Processor</T3>

      <Paragraph>
        The GDPR distinguishes between organisations that process personal information for their own
        purposes (known as &ldquo;data controllers&rdquo;) and organizations that process personal
        information on behalf of other organizations (known as &ldquo;data processors&rdquo;). We,
        Disclave, located at the address provided in our Contact Us section, are a Data Controller
        with respect to the personal information you provide to us.
      </Paragraph>

      <T3>Legal Bases for Processing Your Personal Information</T3>
      ...
      <T4>Performance of a Contract or Transaction</T4>
      ...
      <T4>Our Legitimate Interests</T4>
      ...
      <T3>International Transfers Outside of the European Economic Area (EEA)</T3>
      ...
      <T3>Your Rights and Controlling Your Personal Information</T3>
      ...
      <T2>Additional Disclosures for California Compliance (US)</T2>
      ...
      <T3>CCPA-permitted financial incentives</T3>
      ...
      <T3>California Notice of Collection</T3>
      ...
      <T3>Right to Know and Delete</T3>
      ...
      <List>
        <ListItem>The categories of personal information we have collected about you;</ListItem>
        <ListItem>The categories of sources from which the personal information was collected;</ListItem>
        <ListItem>
        ...
        <ListItem>The specific pieces of personal information we have collected about you.</ListItem>
      </List>
      <Paragraph>
